...
function hashLinkScroll() {
  const { hash } = window.location; // eslint-disable-line no-undef
  if (hash !== '') {
    setTimeout(() => {
...
// Provider makes the store available to all container
// components in the app without passing it explicitly. Only required to render once.
ReactDOM.render(
