...
const mapDispatchToProps = dispatch => ({
  ...
  onChangeCompany: value => dispatch({ type: 'UPDATE_FIELD_AUTH', key: 'company', value }),
  onChangePosition: value => dispatch({ type: 'UPDATE_FIELD_AUTH', key: 'position', value }),
  onChangePhoneNumber: value => dispatch({ type: 'UPDATE_FIELD_AUTH', key: 'phoneNumber', value }),
  onChangeSecret: value => dispatch({ type: 'UPDATE_FIELD_AUTH', key: 'secret', value }),
