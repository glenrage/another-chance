...
router.post('/users/login', (req, res, next) => {
  ...
  // use local strategy as defined in config for authentication.
  // session:false to prevent Passport from serializing user info in the sesion.
  // Callback will respond to client based off if authentication was successful or not
