...
// intercept all queries related to animal
// and add animals data to req.animal for other routes to use
...
// This method takes an array of promises and tries to resolve all
// promises, then passes an array of resolved values to the attached
// .then handler. Any values not wrapped in a promise will be considered resolved.
